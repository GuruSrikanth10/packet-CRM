...
# setdefault) so this entrypoint is always the DLT consumer regardless of what
# the parent environment happens to contain -- see the CONSUMER_ROLE block at
# the top of src/utils/kafkaConsumer.py.
os.environ["CONSUMER_ROLE"] = "dlt"
